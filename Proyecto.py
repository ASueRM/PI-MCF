...
plt.plot(resultados.index, resultados['VaR 95% Histórico'], label='VaR 95% Histórico', color='#E56717', linestyle='-')
plt.plot(resultados.index, resultados['VaR 99% Histórico'], label='VaR 99% Histórico', color='#FFA800', linestyle='-')
plt.plot(resultados.index, resultados['ES 95% Histórico'], label='ES 95% Histórico', color='#191970', linestyle='-')
plt.plot(resultados.index, resultados['ES 99% Histórico'], label='ES 99% Histórico', color='#097364', linestyle='-')
